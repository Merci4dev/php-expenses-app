<?php
    ...
    # Set the a model to make innerJoin between tow  tables.
    # ====================================================
    class JoinExpensesCategoriesModel extends Model{
        ...
        # Immer Join get all data for the tables expenses and categories
        # ====================================================
        ...
        # Make the asociations between the class members and a array. Here, base in an array asign the values to the class members
        # ====================================================
        ...
        #  Here, base in the class members we make an array . Transform an object to an array
        # ====================================================
        ...
        # Set the gether and sether methods
        # ====================================================
